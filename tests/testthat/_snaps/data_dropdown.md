# data_dropdown
    ...
    Output
      ...
      <span class="mdi mdi-checkbox-blank-circle icon-left"></span><span class='dropdown-label'>integer</span><span class="mdi mdi-menu-right float-right icon-right"></span></div></div>
        <div class="dropdown-divider"></div>
        <div class="btn-group-toggle dropdown-group dropright">
          <div id="units" role="button" class="btn dropdown-item dropdown-btn submenu" data-toggle ="dropdown"  aria-haspopup ="true"  aria-expanded="false" >
